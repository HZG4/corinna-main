...
// using a plain <img> with onError fallback because some external
// Uploadcare IDs may return 404 in dev; fallback prevents broken UI
              ...
              <div className="">
                <div className="w-10 h-10 relative">
                  <img
                    ...
                    onError={(e) => {
                      // data-URI placeholder (neutral gray box)
